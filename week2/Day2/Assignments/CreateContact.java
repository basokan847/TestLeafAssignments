...
public class CreateContact {
	...
	public static void main(String[] args) {
		...
		//Find and Update Important note value
		WebElement elementImpNote = driver.findElement(By.id("updateLeadForm_importantNote"));
		elementImpNote.sendKeys("Test Important Data Message");
		//Click Update button
		driver.findElement(By.xpath("(//input[@type='submit'])[1]")).click();
		//Get and print the title of given page
		driver.getTitle();
		System.out.println("Title of result page is : "+driver.getTitle());
		WebElement elementViewImpNote = driver.findElement(By.id("viewLead_importantNote_sp"));
		System.out.println("Important Note is : "+elementViewImpNote.getText());
		driver.close();
	}
}
